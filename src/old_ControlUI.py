...
class TeslaStyleApp(ctk.CTk):
    def __init__(self):
        ...
        self.add_slider('accelleration', 'Acceleration: 0 m/s²', from_=2.0, to=7.6, row=0)  # Range taken from CarMaker and Bae Paper.
        self.add_slider('decelleration', 'Deceleration: 0 m/s²', from_=-2.0, to=-7.6, row=1)  # example range
    ...
    def update_toggle(self, name, value):
        ...
        self.logger.log_value_change([self.toggle_state.get(key) for key in self.toggle_state.keys()])


    # def update_driveMode_value(self, value):
    #    self.update_toggle('driveMode', value)

    # ------------------- Update Value -------------------      

    def update_accelleration_value(self, event):
        value = self.accelleration_slider.get()
        self.accelleration_slider_label.configure(text=f"Acceleration: {value:.2f} m/s²")
        self.cm.DVA_write(self.qacceleration, value)
        self.logger.log_value_change([value, None, None, None, None, None, None, None, None])  # Log the value

    def update_decelleration_value(self, event):
        value = self.decelleration_slider.get()
        self.decelleration_slider_label.configure(text=f"Deceleration: {value:.2f} m/s²")
        self.cm.DVA_write(self.qdeceleration, value)
        self.logger.log_value_change([None, value, None, None, None, None, None, None, None])  # Log the value
    ...
    def update_lane_offset_value(self, event):
        ...
        self.logger.log_value_change([None, None, value, None, None, None, None, None, None])  # Log the value

    def update_consider_value(self, event):
        value = self.consider_button_On.cget('text')
        self.consider_toggle_label.configure(text=f"Consider Overtake: {value}")
        self.cm.DVA_write(self.qconsider, value)
        self.logger.log_value_change([None, None, None, value, None, None, None, None, None])  # Log the value

    def update_overtake_value(self, event):
        value = self.overtake_button_On.cget('text')
        self.overtake_toggle_label.configure(text=f"Overtake: {value}")
        self.cm.DVA_write(self.qovertake, value)
        self.logger.log_value_change([None, None, None, None, value, None, None, None, None])
    ...
    def update_steer_trq_value(self, event):
        ...
        self.logger.log_value_change([None, None, None, None, None, value, None, None, None])  # Log the value
    ...
    def update_steerAccel_value(self, event):
        ...
        self.logger.log_value_change([None, None, None, None, None, None, value, None, None]) 
    ...
    def update_steerVeloc_value(self, event):
        ...
        self.logger.log_value_change([None, None, None, None, None, None, None, value, None])

    def update_speed_value(self, event):
        value = self.speed_slider.get()
        self.speed_slider_label.configure(text=f"Speed: {value:.2f}"), None, None
        self.cm.DVA_write(self.qspeed, value)
        self.logger.log_value_change([None, None, None, None, None, None, None, None, value])

    # def update_driveMode_value(self, event):
    #     value = self.driveMode_slider.get()
    #     self.driveMode_slider_label.configure(text=f"Drive Mode: {value}")
    #     self.cm.DVA_write(self.qdriveMode, value)
    #     self.logger.log_value_change([None, None, None, None, None, None, None, None, None, value])
