...
class TeslaStyleApp(ctk.CTk):
    def __init__(self):
        ...
        self.add_slider('lane_change', 'Timing Lane Change: 0²', from_=-300.0, to=300.0, row=5)  # example range
        self.add_slider('speed', 'Speed: 0 km/h', from_=0.0, to=300.0, row=6)  # example range
